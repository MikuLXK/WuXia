...
const SettingsModal: React.FC<Props> = ({ 
    ...
    return (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-[200] flex items-center justify-center p-4 animate-fadeIn">
            <div className="bg-ink-black/90 border border-wuxia-gold/40 w-full max-w-4xl h-[700px] flex shadow-[0_0_80px_rgba(0,0,0,0.9)] relative overflow-hidden rounded-md backdrop-blur-md">
                    {/* Modal Deco */}
                    <div className="absolute top-0 left-0 w-32 h-32 border-t-2 border-l-2 border-wuxia-red/60 -translate-x-4 -translate-y-4 rounded-tl-3xl pointer-events-none"></div>
                    <div className="absolute bottom-0 right-0 w-32 h-32 border-b-2 border-r-2 border-wuxia-red/60 translate-x-4 translate-y-4 rounded-br-3xl pointer-events-none"></div>
